...
class SerieRepository extends ServiceEntityRepository
{
    ...
    public function findSeriesByGenreWithDql(): array
    {
        //avec DQL, on requête ss forme entité
        //pour obtenir resutlat ss forme entité

        $q = "SELECT s FROM App\Entity\Serie 
        WHERE s.genres LIKE :genre 
        AND WHERE s.status = :status 
