...
#[UniqueEntity(fields: ['name','firstAirDate'], message: 'Une série avec ce nom et cette première date de diffusion existe déjà.')]
class Serie
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[Assert\NotBlank]
    #[Assert\Length(min: 3, max: 10, minMessage: 'Nom trop court. Le nom doit être compris entre {{ limit }} et ? caractères.')]
    ...
    #[ORM\PrePersist] public function setDateCreated(): static
    {
    ...
    #[ORM\PreUpdate] public function setDateModified(): static
    {
